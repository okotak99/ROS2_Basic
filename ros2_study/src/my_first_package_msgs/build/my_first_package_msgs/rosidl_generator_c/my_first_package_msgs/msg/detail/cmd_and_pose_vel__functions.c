...
my_first_package_msgs__msg__CmdAndPoseVel__are_equal(const my_first_package_msgs__msg__CmdAndPoseVel * lhs, const my_first_package_msgs__msg__CmdAndPoseVel * rhs)
{
  ...
  // angulat_vel
  if (lhs->angulat_vel != rhs->angulat_vel) {
    return false;
  }
  return true;
}
  ...
  my_first_package_msgs__msg__CmdAndPoseVel * output)
{
  ...
  // angulat_vel
  output->angulat_vel = input->angulat_vel;
  return true;
}
...
my_first_package_msgs__msg__CmdAndPoseVel__create()
{
  ...
  my_first_package_msgs__msg__CmdAndPoseVel * msg = (my_first_package_msgs__msg__CmdAndPoseVel *)allocator.allocate(sizeof(my_first_package_msgs__msg__CmdAndPoseVel), allocator.state);
  if (!msg) {
    return NULL;
  }
...
my_first_package_msgs__msg__CmdAndPoseVel__Sequence__init(my_first_package_msgs__msg__CmdAndPoseVel__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (my_first_package_msgs__msg__CmdAndPoseVel *)allocator.zero_allocate(size, sizeof(my_first_package_msgs__msg__CmdAndPoseVel), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_first_package_msgs__msg__CmdAndPoseVel__Sequence * array = (my_first_package_msgs__msg__CmdAndPoseVel__Sequence *)allocator.allocate(sizeof(my_first_package_msgs__msg__CmdAndPoseVel__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  my_first_package_msgs__msg__CmdAndPoseVel__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    my_first_package_msgs__msg__CmdAndPoseVel * data =
      (my_first_package_msgs__msg__CmdAndPoseVel *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_first_package_msgs__msg__CmdAndPoseVel__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_first_package_msgs__msg__CmdAndPoseVel__fini(&output->data[i]);
        }
        return false;
      }
    }
