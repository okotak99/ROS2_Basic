  ...
  std::ostream & out)
{
  ...
  {
    out << "angulat_vel: ";
    rosidl_generator_traits::value_to_yaml(msg.angulat_vel, out);
  }
  out << "}";
...
[[deprecated("use my_first_package_msgs::msg::to_block_style_yaml() instead")]]
inline void to_yaml(
  const my_first_package_msgs::msg::CmdAndPoseVel & msg,
  std::ostream & out, size_t indentation = 0)
{
  my_first_package_msgs::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use my_first_package_msgs::msg::to_yaml() instead")]]
inline std::string to_yaml(const my_first_package_msgs::msg::CmdAndPoseVel & msg)
{
  return my_first_package_msgs::msg::to_yaml(msg);
}
