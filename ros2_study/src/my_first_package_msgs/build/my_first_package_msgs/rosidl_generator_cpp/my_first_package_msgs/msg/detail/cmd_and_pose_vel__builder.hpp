...
class Init_CmdAndPoseVel_angulat_vel
{
public:
  explicit Init_CmdAndPoseVel_angulat_vel(::my_first_package_msgs::msg::CmdAndPoseVel & msg)
  : msg_(msg)
  {}
  ::my_first_package_msgs::msg::CmdAndPoseVel angulat_vel(::my_first_package_msgs::msg::CmdAndPoseVel::_angulat_vel_type arg)
  {
    msg_.angulat_vel = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_CmdAndPoseVel_angulat_vel linear_vel(::my_first_package_msgs::msg::CmdAndPoseVel::_linear_vel_type arg)
  {
    msg_.linear_vel = std::move(arg);
    return Init_CmdAndPoseVel_angulat_vel(msg_);
  }
