...
bool my_first_package_msgs__msg__cmd_and_pose_vel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_first_package_msgs.msg._cmd_and_pose_vel.CmdAndPoseVel", full_classname_dest, 57) == 0);
  }
  my_first_package_msgs__msg__CmdAndPoseVel * ros_message = _ros_message;
  {  // cmd_vel_linear
  ...
  {  // angulat_vel
    PyObject * field = PyObject_GetAttrString(_pymsg, "angulat_vel");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->angulat_vel = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * my_first_package_msgs__msg__cmd_and_pose_vel__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_first_package_msgs.msg._cmd_and_pose_vel");
  ...
  {  // angulat_vel
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->angulat_vel);
    {
      int rc = PyObject_SetAttrString(_pymessage, "angulat_vel", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
