  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: angulat_vel
  {
    cdr << ros_message->angulat_vel;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name angulat_vel
  {
    size_t item_size = sizeof(ros_message->angulat_vel);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_first_package_msgs__msg__CmdAndPoseVel;
    is_plain =
      (
      offsetof(DataType, angulat_vel) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _CmdAndPoseVel__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_first_package_msgs__msg__CmdAndPoseVel(
