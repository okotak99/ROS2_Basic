...
class CmdAndPoseVel(metaclass=Metaclass_CmdAndPoseVel):
    ...
    def __init__(self, **kwargs):
        ...
        self.angulat_vel = kwargs.get('angulat_vel', float())
    ...
    def __eq__(self, other):
        ...
        if self.linear_vel != other.linear_vel:
            return False
        if self.angulat_vel != other.angulat_vel:
            return False
        return True
    ...
    @builtins.property
    def angulat_vel(self):
        """Message field 'angulat_vel'."""
        return self._angulat_vel

    @angulat_vel.setter
    def angulat_vel(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'angulat_vel' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'angulat_vel' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._angulat_vel = value
